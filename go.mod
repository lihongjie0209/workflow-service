module github.com/lihongjie0209/workflow-service
...
require (
	...
	github.com/lihongjie0209/microservice-platform-go v0.9.2
	github.com/lihongjie0209/platform-protos v0.11.1
