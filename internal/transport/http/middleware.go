...
func workflowHTTPRequirement(route string) (platformauthz.Requirement, bool) {
	...
	requirements := map[string]platformauthz.Requirement{
		...
		"/api/v1/workflow/instances/start-definitions/list": {Resource: "workflow.instance", Action: "start", Scope: principal},
		"/api/v1/workflow/instances/definitions/list":       {Resource: "workflow.instance", Action: "list", Scope: principal},
